...
public class CalcBaseListener implements CalcListener {
     ...
     */
    @Override
    public void enterPar(@NotNull CalcParser.ParContext ctx) {
    }
     ...
     */
    @Override
    public void enterMinus(@NotNull CalcParser.MinusContext ctx) {
    }
     ...
     */
    @Override
    public void enterNumber(@NotNull CalcParser.NumberContext ctx) {
    }
     ...
     */
    @Override
    public void enterTimes(@NotNull CalcParser.TimesContext ctx) {
    }
     ...
     */
    @Override
    public void enterComplete(@NotNull CalcParser.CompleteContext ctx) {
    }
     ...
     */
    @Override
    public void exitComplete(@NotNull CalcParser.CompleteContext ctx) {
    }
     ...
     */
    @Override
    public void enterPlus(@NotNull CalcParser.PlusContext ctx) {
    }
